...
This document describes the color system and component usage for the UI library.

## Color Variables

The design system uses semantic color variables that reference base color tokens. These variables are defined in CSS custom properties and support both light and dark themes.
...
These variables reference base color tokens defined in `packages/ui/src/styles/colors.css`. The system supports both light and dark themes with different values applied via media queries in `theme.css`.

## Component Usage

### Button

Uses: `--border-base`, `--surface-brand-base`, `--text-on-brand-strong`, `--border-hover`, `--surface-brand-hover`, `--border-active`, `--surface-brand-active`, `--border-focus`, `--surface-brand-focus`, `--border-weak-base`, `--button-secondary-base`, `--text-strong`, `--surface-hover`, `--surface-active`, `--surface-focus`, `--icon-strong-base`, `--border-disabled`, `--surface-disabled`, `--text-weak`

### Input

Uses: `--text-strong`, `--text-weak`

### Select

Uses: `--text-weak`, `--border-weak-base`, `--surface-raised-stronger-non-alpha`, `--text-strong`, `--surface-raised-base-hover`, `--surface-raised-base`

### Dialog

Uses: `--border-base`, `--surface-raised-stronger-non-alpha`, `--text-strong`

### Tabs

Uses: `--background-stronger`, `--border-weak-base`, `--background-base`, `--text-base`, `--text-weaker`, `--border-focus`, `--text-strong`

### Tooltip

Uses: `--surface-float-base`, `--white`, `--shadow-md`
...
Uses: `--surface-raised-base-hover`

### Accordion

Uses: `--border-weak-base`, `--surface-base`, `--text-strong`
...
Uses: `--icon-strong-disabled`, `--icon-invert-base`, `--icon-strong-base`, `--icon-strong-hover`, `--icon-strong-active`, `--icon-strong-focus`, `--button-secondary-base`, `--text-strong`, `--surface-hover`, `--surface-active`, `--surface-focus`, `--icon-weak-base`, `--icon-weak-hover`

### Select Dialog

Uses: `--surface-base`, `--text-weak`, `--text-strong`, `--surface-raised-base-hover`
